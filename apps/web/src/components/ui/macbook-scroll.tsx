...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[160vh] md:min-h-[175vh] flex flex-col items-center py-0 md:py-8 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.50] sm:scale-75 -translate-y-[2rem]"
    >
      <motion.div
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="h-96 w-[32rem] absolute inset-0 bg-[#010101] rounded-2xl p-2.5 overflow-hidden shadow-2xl border border-slate-700/60"
      >
        <div className="absolute inset-0 bg-[#060a14] rounded-xl overflow-hidden flex flex-col">
          {children ? (
            children
          ) : (
            src && (
